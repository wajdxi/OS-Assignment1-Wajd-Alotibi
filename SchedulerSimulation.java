...
public class SchedulerSimulation {
    public static void main(String[] args) {
        ...
        System.out.println("\n" + Colors.BOLD + Colors.BRIGHT_CYAN + 
                          ...
                          Colors.RESET);
        System.out.
        println(Colors.BOLD + Colors.BRIGHT_CYAN + "║" + Colors.RESET + 
        ...
        System.out.println(Colors.BOLD + Colors.BRIGHT_CYAN + "║" + Colors.RESET + 
                          Colors.YELLOW + "  ⚙️ Processes:     " + Colors.RESET + Colors.BRIGHT_YELLOW + 
                          String.format("%-65s", numProcesses) + 
                          Colors.BOLD + Colors.BRIGHT_CYAN + "║" + Colors.RESET);
        System.out.println(Colors.BOLD + Colors.BRIGHT_CYAN + "║" + Colors.RESET + 
                          Colors.YELLOW + "  ⏱️ Time Quantum:  " + Colors.RESET + Colors.BRIGHT_YELLOW + 
